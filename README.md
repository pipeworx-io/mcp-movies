...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/search_movies \
  -H 'Content-Type: application/json' \
  -d '{"query":"Inception"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/search_movies`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
